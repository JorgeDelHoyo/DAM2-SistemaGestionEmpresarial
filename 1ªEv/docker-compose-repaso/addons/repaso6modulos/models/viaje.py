...
class Viaje(models.Model):
    ...
    compra_ids = fields.One2many('repaso6modulos.compra', 'viaje_id', string='Compras')
    ...
    actividad_extra_ids = fields.Many2many('repaso6modulos.actividad.extra', string='actividad_extra')